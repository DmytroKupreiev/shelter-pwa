...
!(function(t) {
  ...
  var e = function() {
    ...
    return _cc(t, [{
      ...
      value: function(t) {
        var i = this.srpiq();
        return 3 === t ? (this.x = i.x + i.halfWidth, void(this.y = i.y)) : 
          2 === t ? (this.x = i.x, void(this.y = i.y + i.halfHeight)) : 
          1 === t ? (this.x = i.x + i.halfWidth, void(this.y = i.y + i.halfHeight)) : 
      ...
      value: function(t, s, e) {
        this.o.size.pulse && (this.s += this.o.size.pulse * this.d, 
        ...
        if ("t" === this.h) {
          var v = Math.tan(.017453 * Math.abs(30)) * r,
            g = this.y + v;
          t.moveTo(this.x - r, g),
          t.lineTo(this.x + r, g),
  ...
  h = function() {
    ...
    return _cc(h, [{
      ...
      value: function() {
        ...
        this.c.setAttribute("style", "position:absolute;z-index:-1;top:0;left:0;right:0;bottom:0;outline: 1px solid transparent;background-color:rgba(" + this.bc.r + "," + this.bc.g + "," + this.bc.b + ",1);")
      }
    }, {
      key: "init",
      value: function(t) {
